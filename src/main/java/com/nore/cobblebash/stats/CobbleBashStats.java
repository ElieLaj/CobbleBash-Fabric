...
public class CobbleBashStats {
    public static final ResourceLocation GYMS_COMPLETED_ID =
            ResourceLocation.fromNamespaceAndPath(CobbleBash.MODID, "gyms_completed");

    // Fabric n'a pas de registre differe : on enregistre directement, depuis
    // l'initialiseur du mod. Une statistique personnalisee est un registre de
    // ResourceLocation ou la cle est aussi la valeur.
