 ...
 */
public class ChampionRibbonItem extends Item implements Accessory {
   ...
   public void onEquip(ItemStack stack, SlotReference reference) {
      RibbonAttributeManager.equip(slot(reference), RibbonAttributeManager.RibbonKind.CHAMPION);
   }

   @Override
   public void onUnequip(ItemStack stack, SlotReference reference) {
      RibbonAttributeManager.unequip(slot(reference), RibbonAttributeManager.RibbonKind.CHAMPION);
   }
