...
public class EliteFourChampionModel extends EntityModel<GymLeaderEntity> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
      ResourceLocation.fromNamespaceAndPath("cobblebash", "elite_four_champion"), "main"
   );
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition partdefinition4 = partdefinition1.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(116, 122)
            .addBox(6.0F, 0.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.05F))
            .texOffs(116, 116)
            .addBox(-8.0F, 0.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.05F)),
         PartPose.offset(0.0F, -12.0F, 0.0F)
      );
      ...
      PartDefinition partdefinition6 = partdefinition5.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 107)
            .addBox(-1.15F, -1.0F, -0.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(-1.15F, -1.0F, -4.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(-2.6F, -1.0F, -4.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(-7.85F, -1.0F, -4.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(-6.4F, -1.0F, -4.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(-6.4F, -1.0F, -0.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(-7.85F, -1.0F, -0.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(-2.6F, -1.0F, -0.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(-4.5F, -1.0F, -0.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)),
         PartPose.offset(4.0F, -1.0F, 4.0F)
      );
      PartDefinition partdefinition7 = partdefinition4.addOrReplaceChild(
         "Badge",
         CubeListBuilder.create()
            .texOffs(0, 5)
      ...
      PartDefinition partdefinition8 = partdefinition1.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(0, 107)
            .addBox(-3.1F, 3.65F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(-3.1F, 2.15F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(-3.1F, 0.65F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-5.0F, -10.0F, 0.0F)
      );
      PartDefinition partdefinition9 = partdefinition8.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(12, 125).addBox(-1.0F, -1.65F, 0.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-3.1F, 9.0F, 0.0F, 0.0F, 1.5708F, 0.0F)
      );
      PartDefinition partdefinition10 = partdefinition1.addOrReplaceChild(
         "Left_Arm",
         CubeListBuilder.create()
            .texOffs(16, 32)
            ...
            .texOffs(0, 107)
            .addBox(2.1F, 0.65F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(2.1F, 2.15F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(0, 107)
            .addBox(2.1F, 3.65F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offset(5.0F, -10.0F, 0.0F)
      );
      PartDefinition partdefinition11 = partdefinition10.addOrReplaceChild(
         "cube_r2",
         CubeListBuilder.create().texOffs(12, 125).addBox(-1.0F, -1.65F, 0.8F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(3.9F, 9.0F, 0.0F, 0.0F, -1.5708F, 0.0F)
      );
      PartDefinition partdefinition12 = partdefinition.addOrReplaceChild("Legs", CubeListBuilder.create(), PartPose.offset(-1.9F, 12.0F, 0.0F));
      ...
      PartDefinition partdefinition16 = partdefinition12.addOrReplaceChild(
         "Right_Leg",
         CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, 0.0F, 0.0F)
      );
      PartDefinition partdefinition17 = partdefinition16.addOrReplaceChild(
         "Right_Leg_Cover_r1",
         CubeListBuilder.create().texOffs(0, 48).addBox(-1.6F, -3.0F, -2.0F, 3.0F, 9.0F, 4.0F, new CubeDeformation(0.2F)),
         PartPose.offsetAndRotation(-1.1F, 2.0F, 0.0F, 0.0F, 3.1416F, 0.1309F)
      );
      PartDefinition partdefinition18 = partdefinition16.addOrReplaceChild(
         "Shoe_Right",
         CubeListBuilder.create()
            .texOffs(0, 123)
