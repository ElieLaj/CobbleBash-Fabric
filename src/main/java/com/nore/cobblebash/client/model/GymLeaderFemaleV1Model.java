...
public class GymLeaderFemaleV1Model extends EntityModel<GymLeaderEntity> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
      ResourceLocation.fromNamespaceAndPath("cobblebash", "gym_leader_female_v1"), "main"
   );
   ...
   public GymLeaderFemaleV1Model(ModelPart root) {
      this.root = root;
