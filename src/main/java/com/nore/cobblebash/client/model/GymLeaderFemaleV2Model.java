...
public class GymLeaderFemaleV2Model extends EntityModel<GymLeaderEntity> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
      ResourceLocation.fromNamespaceAndPath("cobblebash", "gym_leader_female_v2"), "main"
   );
   ...
   public GymLeaderFemaleV2Model(ModelPart root) {
      this.root = root;
