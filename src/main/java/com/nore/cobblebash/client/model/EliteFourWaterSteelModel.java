...
public class EliteFourWaterSteelModel extends EntityModel<GymLeaderEntity> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
      ResourceLocation.fromNamespaceAndPath("cobblebash", "elite_four_water_steel"), "main"
   );
   ...
   public EliteFourWaterSteelModel(ModelPart root) {
